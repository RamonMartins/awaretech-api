...
const char* enviar_sensor_vibracao = "https://awaretech-api-production.up.railway.app/enviar_sensor_vibracao";
const char* enviar_sensor_corrente = "https://awaretech-api-production.up.railway.app/enviar_sensor_corrente";
